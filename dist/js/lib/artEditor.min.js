...
$.fn.extend({
    _opt: {
        ...
        limitSize: 2,   // 兆
        showServer: true,
        uploadUrl: 'http://10.1.0.26:8081/whoami/meetingDynamic/upload',
        data: {},
        uploadField: 'image',
        ...
        try {
            $(t._opt.imgTar).on("change", function (e) {
                ...
                r.readAsDataURL(a), r.onload = function (e) {
                    ...
                    var a = '<img src="' + e.target.result + '" style="width:100%;" /><br/>';
                    t.insertImage(a)
                }
   ...
   $.ajax({
            ...
            if (a) {
                var r = '<img src="' + a + '" style="width:100%;" /><br/>';
                t.insertImage(r)
    ...
    insertImage: function (e) {
        ...
        if (window.getSelection) {
            ...
            for (var r = a.createContextualFragment(e), o = r.lastChild; o && "br" == o.nodeName.toLowerCase() && o.previousSibling && "br" == o.previousSibling.nodeName.toLowerCase();) {
                var l = o;
                o = o.previousSibling, r.removeChild(l)
            }
